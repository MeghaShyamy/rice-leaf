...
(async function () {
	...
	model = await tf.loadLayersModel('https://meghashyamy.github.io/rice-leaf/model_2/model.json', 
	{onProgress: p => move(p)}); // <-- Take note of this
	
	$("#selected-image").attr("src", "https://meghashyamy.github.io/rice-leaf/assets/Train_1784_multiple_diseases.jpg")
