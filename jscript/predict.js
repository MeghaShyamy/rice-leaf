...
(async function () {
	...
	model = await tf.loadLayersModel('https://meghashyamy.github.io/rice-leaf/model_v3/model.json',
	{onProgress: p => move(p)});
	
	$("#selected-image").attr("src", "https://meghashyamy.github.io/rice-leaf/assets/brown_spot.jpg")
